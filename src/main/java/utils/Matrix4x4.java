...
public class Matrix4x4 
{
  ...
  public Vector4 transformVector4(Vector4 vector4)
  {
      double x = vector4.getElement(0) * m_[0]  +
                 vector4.getElement(1) * m_[4]  +
                 vector4.getElement(2) * m_[8]  +  
                 vector4.getElement(3) * m_[12];

      double y = vector4.getElement(0) * m_[1]  +
                 vector4.getElement(1) * m_[5]  +
                 vector4.getElement(2) * m_[9]  +  
                 vector4.getElement(3) * m_[13];

      double z = vector4.getElement(0) * m_[2]   +
                 vector4.getElement(1) * m_[6]   +
                 vector4.getElement(2) * m_[10]  + 
                 vector4.getElement(3) * m_[14];

      double w = vector4.getElement(0) * m_[3]   +
              	 vector4.getElement(1) * m_[7]   +
              	 vector4.getElement(2) * m_[11]  + 
              	 vector4.getElement(3) * m_[15];
